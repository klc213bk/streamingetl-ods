...
(
"FEE_ID" NUMBER(14,0) NOT NULL, 
	"SOURCE_ID" NUMBER(14,0) NOT NULL, 
	"SOURCE_TABLE" NUMBER(1,0) NOT NULL, 
	"COMMISION_TYPE_ID" NUMBER(10,0) NOT NULL, 
	"COMMISION" NUMBER(18,6) DEFAULT 0 NOT NULL, 
	...
	"POL_COMMISION" NUMBER(18,6) DEFAULT 0 NOT NULL, 
	"CHEQUE_ID" NUMBER(19,0), 
	"DIVISION_INDI" CHAR(1 BYTE) DEFAULT 'N' NOT NULL, 
	"REPLY_CODE" VARCHAR2(2 BYTE), 
	"TRIGGER_CODE" VARCHAR2(2 BYTE), 
	"PREM_YEAR" VARCHAR2(3 BYTE), 
	"COMM_STATUS" NUMBER(2,0) NOT NULL, 
	...
	"HEAD_AGENT_ID" NUMBER(19,0), 
	 CONSTRAINT "PK_K_COMMISION_FEE" PRIMARY KEY ("FEE_ID")
)
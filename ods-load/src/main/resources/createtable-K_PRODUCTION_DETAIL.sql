CREATE TABLE K_PRODUCTION_DETAIL
   (	
"DETAIL_ID" NUMBER(14,0) NOT NULL , 
	"PRODUCTION_ID" NUMBER(19,0) NOT NULL , 
	"POLICY_ID" NUMBER(19,0), 
	"ITEM_ID" NUMBER(19,0), 
	"PRODUCT_ID" NUMBER(19,0), 
	"POLICY_YEAR" NUMBER(3,0), 
	"PRODUCTION_VALUE" NUMBER(20,4) NOT NULL , 
	"EFFECTIVE_DATE" DATE NOT NULL , 
	"HIERARCHY_DATE" DATE, 
	"PRODUCER_ID" NUMBER(19,0) NOT NULL , 
	...
	"HIERARCHY_EXIST_INDI" CHAR(1 BYTE) DEFAULT 'N' NOT NULL , 
	...
	"RECALCULATED_INDI" CHAR(1 BYTE) DEFAULT 'W', 
	"EXCLUDE_POLICY_INDI" CHAR(1 BYTE) DEFAULT 'N', 
	...
	"ACCEPT_ID" NUMBER(19,0), 
	 CONSTRAINT "PK_K_PRODUCTION_DETAIL" PRIMARY KEY ("DETAIL_ID")
);

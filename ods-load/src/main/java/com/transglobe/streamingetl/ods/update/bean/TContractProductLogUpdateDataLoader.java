...
public class TContractProductLogUpdateDataLoader extends UpdateDataLoader {

	private static final Logger logger = LoggerFactory.getLogger(TContractProductLogUpdateDataLoader.class);

	private static final String UPDATE_TABLE_NAME = "T_CONTRACT_PRODUCT_LOG_UPDATE";

	private static final String UPDATE_TABLE_CREATE_FILE_NAME = "update/createtable-T_CONTRACT_PRODUCT_LOG_UPDATE.sql";
	...
	public TContractProductLogUpdateDataLoader(Config config, String fromUpdateTime, String toUpdateTime) throws Exception {
				...
				)
		{
					...
					sourcePstmt.executeQuery())
			{
				...
				while (rs.next())
				{
					...
					sinkPstmt.setString(193, rs.getString("HIDE_VALIDATE_DATE_INDI"));
					sinkPstmt.setBigDecimal(194, rs.getBigDecimal("ETI_SUR_PB"));
					sinkPstmt.setBigDecimal(195, rs.getBigDecimal("ETA_PAIDUP_AMOUNT"));
					sinkPstmt.setBigDecimal(196, rs.getBigDecimal("ORI_PREMIUM_ADJUST_YEARLY"));
					sinkPstmt.setBigDecimal(197, rs.getBigDecimal("ORI_PREMIUM_ADJUST_HALFYEARLY"));
					sinkPstmt.setBigDecimal(198, rs.getBigDecimal("ORI_PREMIUM_ADJUST_QUARTERLY"));
					sinkPstmt.setBigDecimal(199, rs.getBigDecimal("ORI_PREMIUM_ADJUST_MONTHLY"));
					sinkPstmt.setBigDecimal(200, rs.getBigDecimal("CLAIM_DISABILITY_RATE"));
					sinkPstmt.setString(201, rs.getString("HEALTH_INSURANCE_INDI"));
					sinkPstmt.setString(202, rs.getString("INSURANCE_NOTICE_INDI"));
					sinkPstmt.setString(203, rs.getString("SERVICES_BENEFIT_LEVEL"));
					sinkPstmt.setString(204, rs.getString("PAYMENT_FREQ"));
					sinkPstmt.setString(205, rs.getString("ISSUE_TYPE"));
					sinkPstmt.setString(206, rs.getString("LOADING_RATE_POINTER_REASON"));
					sinkPstmt.setString(207, rs.getString("RELATION_TO_PH_ROLE"));
					sinkPstmt.setBigDecimal(208, rs.getBigDecimal("MONEY_DENOMINATED"));
					sinkPstmt.setBigDecimal(209, rs.getBigDecimal("ORIGIN_PRODUCT_VERSION_ID"));
					sinkPstmt.setDate(210, rs.getDate("TRANSFORM_DATE"));
					sinkPstmt.setString(211, rs.getString("HEALTH_INSURANCE_VERSION"));
					
					sinkPstmt.setLong(212, rs.getLong("ORA_ROWSCN"));		// new column
					sinkPstmt.setString(213,  rs.getString("ROWID"));		// new column

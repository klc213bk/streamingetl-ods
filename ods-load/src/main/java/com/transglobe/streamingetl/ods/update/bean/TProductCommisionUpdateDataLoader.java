...
public class TProductCommisionUpdateDataLoader extends UpdateDataLoader {

	private static final Logger logger = LoggerFactory.getLogger(TProductCommisionUpdateDataLoader.class);

	private static final String UPDATE_TABLE_NAME = "T_PRODUCT_COMMISION_UPDATE";

	private static final String UPDATE_TABLE_CREATE_FILE_NAME = "update/createtable-T_PRODUCT_COMMISION_UPDATE.sql";
	...
	public TProductCommisionUpdateDataLoader(Config config, String fromUpdateTime, String toUpdateTime) throws Exception {
	...
	protected String getSelectSql() {
		return "select"
				...
				+ " a where ? <= a.ITEM_ID and a.ITEM_ID < ? and to_date(?, 'YYYY-MM-DD') <= UPDATE_TIME and UPDATE_TIME < to_date(?, 'YYYY-MM-DD')";
	}
				...
				)
		{
					...
					sourcePstmt.executeQuery())
			{
				...
				while (rs.next())
				{
					...
					sinkPstmt.setString(116, rs.getString("COMMENTS"));
					sinkPstmt.setString(117, rs.getString("YEAR_MONTH"));
					sinkPstmt.setBigDecimal(118, rs.getBigDecimal("CALC_RST_ID"));
					sinkPstmt.setBigDecimal(119, rs.getBigDecimal("CONVERSION_CATE"));
					sinkPstmt.setString(120, rs.getString("CHEQUE_YEAR_MONTH"));
					sinkPstmt.setBigDecimal(121, rs.getBigDecimal("ENTRY_AGE_"));
					sinkPstmt.setString(122, rs.getString("PRODUCT_VERSION_"));
					sinkPstmt.setString(123, rs.getString("INTERNAL_ID_"));
					sinkPstmt.setString(124, rs.getString("INSURED_CATEGORY_"));
					sinkPstmt.setBigDecimal(125, rs.getBigDecimal("COVERAGE_YEAR_"));
					sinkPstmt.setString(126, rs.getString("COVERAGE_PERIOD_"));
					sinkPstmt.setBigDecimal(127, rs.getBigDecimal("CHARGE_YEAR_"));
					sinkPstmt.setString(128, rs.getString("CHARGE_PERIOD_"));
					sinkPstmt.setBigDecimal(129, rs.getBigDecimal("AMOUNT_"));
					sinkPstmt.setString(130, rs.getString("CHANNEL_CODE_"));
					sinkPstmt.setString(131, rs.getString("INITIAL_TYPE_"));

					sinkPstmt.setString(132, rs.getString("RPT_EXCLUDE_INDI"));
					sinkPstmt.setBigDecimal(133, rs.getBigDecimal("POLICY_PERIOD"));
					sinkPstmt.setDate(134, rs.getDate("CHECK_ENTER_TIME"));
					sinkPstmt.setBigDecimal(135, rs.getBigDecimal("SERVICE_ID"));
					sinkPstmt.setBigDecimal(136, rs.getBigDecimal("ORDER_ID"));
					
					sinkPstmt.setLong(137, rs.getLong("ORA_ROWSCN"));		// new column
					sinkPstmt.setString(138,  rs.getString("ROWID"));		// new column
